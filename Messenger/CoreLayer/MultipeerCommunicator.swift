...
class MultipeerCommunicator: NSObject, Communicator {
    ...
    var online: Bool
    let iPeerID: MCPeerID = MCPeerID(displayName: UIDevice.current.identifierForVendor?.uuidString ?? UIDevice.current.name)
    ...
    override init() {
        ...
        self.myDisplayName = self.iPeerID.displayName
        super.init()

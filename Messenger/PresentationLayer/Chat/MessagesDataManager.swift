...
class MessagesDataManager: NSObject {
    ...
    init(tableView: UITableView, conversationId: String) {
        ...
        self.fetchedResultsController = NSFetchedResultsController<Message>(fetchRequest: fetchRequest, managedObjectContext: AppDelegate.rootAssembly.presentationAssembly.coreDataModel.mainContext, sectionNameKeyPath: nil, cacheName: nil)

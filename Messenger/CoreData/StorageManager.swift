...
class StorageManager: SaveProfileProtocol {
    ...
    func saveUserProfile(userProfile: UserProfile, completion: @escaping (Bool) -> Void) {
        guard let context = CoreDataStack.coreDataStack.saveContext else { return }
        ...
        context.perform {
            ...
            CoreDataStack.coreDataStack.performSave(context: context) {
    ...
    func loadUserProfile(completion: @escaping (UserProfile?) -> Void) {
        guard let mainContext = CoreDataStack.coreDataStack.mainContext else { return }
        mainContext.perform {
...
extension StorageManager: UpdateConversationAndChatCoreDataDelegate {
    ...
    func didReceiveMessage(text: String, fromUser: String, toUser: String) {
        ...
        context.perform {
            ...
            CoreDataStack.coreDataStack.performSave(context: context, completionHandler: nil)
            }
    }
